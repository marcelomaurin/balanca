...
OutputBaseFilename=balanca_setup_01
Compression=lzma
...
Name: "Balanca"; Description: {cm:T_Balanca}

[Components]
Name: "Balanca"; Description: "Arquivos do Balanc"; Types: Balanca;
...
T_Balanca=Balanca
TD_Balanca=Install demo to weight balance 
...
[Files]
Source: "D:\projetos\maurinsoft\balanca\src\balanca.exe"; DestDir: "{app}"; Flags: ignoreversion
